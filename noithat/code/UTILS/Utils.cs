...
namespace UTILS
{
    public class Utils
    {
        public static string GetPromotion(decimal? price, decimal? realprice)
        {
            try
            {
                int result = Convert.ToInt32((realprice - price)*100/realprice);
