...
namespace WebMVC4.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult ListImages(int? currPage, int Month = 0,int Year = 0)
        {
            int CurrPage = 1;
            ...
            var folder = ConfigurationManager.AppSettings["UploadPath"] + "User\\" + HttpContext.User.Identity.Name + "\\" + Year + "\\" + Month.ToString() + "\\";
            ...
            ViewBag.Month = Month;
            ViewBag.hdfCurrentFolder = ConfigurationManager.AppSettings["UploadUrl"] + "User/" + HttpContext.User.Identity.Name + "/" + Year + "/" + Month.ToString() + "/";
