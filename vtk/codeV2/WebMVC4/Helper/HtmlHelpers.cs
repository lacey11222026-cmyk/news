...
namespace WebMVC4.Helper
{
    public static class HtmlHelpers
    {
        ...
        public static string BindChildCategoriesEn(int categoryId, int type)
        {
            ...
            if (_childCategory != null && _childCategory.Count > 0)
            {
                ...
                foreach (CATEGORY_FULL _child in _childCategory)
                {
                    if (_child.Published == 1)
                    {
                        ...
                        if (index == _childCategory.Count - 1)
                        {
                            html += " <li><a  href=\"" + url + "\">" + _child.Language + "</a></li>";
                        }
                        else
                        {
                            html += " <li><a  href=\"" + url + "\">" + _child.Language + "</a></li>";
        ...
        public static string GetDelay(int index)
        {
            string result = "";
            switch (index)
            {
        ...
        public static string GetDelay2(int index)
        {
            string result = "";
            switch (index)
            {
