...
namespace WebMVC4.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(int CategoryId, string CateName, int Page = 1, int Type = 0)
        {
            ...
            {
                lstHotNews = new ContentBO().GetHotNews(CategoryId, 3);
            ...
            {
                lstcate = new CategoryBO().GetAllChildCategories(cateobj.ParentId.GetValueOrDefault(), 0, false);

            }
            else
            {
                lstcate = new CategoryBO().GetAllChildCategories(CategoryId, 0, false);
