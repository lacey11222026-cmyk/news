...
namespace BIZ
{
    public class ContentBO
    {
        ...
        public int ViewAdd(long id,int categoryId)
        {
            ...
            //var strKeyCachedView = strGroupKeyCached + "_"+Constants.CACHE_KEY_CONTENT_ADDCOUNT + id;
            //var totalview = 0;

            //var cachedata = RedisCaching.GetData(strKeyCachedView);
            //if (cachedata != null)
            //    int.TryParse(cachedata.ToString(), out totalview);

            //if (totalview == 0)
            //{
            //    RedisCaching.Add(strKeyCachedView, "1");
            //}
            //else
            //{
            //    RedisCaching.Add(strKeyCachedView, (totalview + 1).ToString());
            //}
            //if (totalview >= 1)
            //{

            //    RedisCaching.Add(strKeyCachedView, "0");
            //    ContentDBBase.Create().ViewAdd(id, categoryId);
            //}
            //return 1;
            return ContentDBBase.Create().ViewAdd(id, categoryId); 
