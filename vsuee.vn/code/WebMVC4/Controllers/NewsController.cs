...
namespace WebMVC4.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(int CategoryId, string CateName, int Page = 1, int Type = 0)
        {
            ...
            //}
            var PageSize = 7;
            if (CategoryId == 69 || CategoryId == 63 || CategoryId == 80 || CategoryId == 95 || CategoryId == 81 || CategoryId == 91 || CategoryId == 92 || CategoryId == 98 || CategoryId == 101 || CategoryId == 102 || CategoryId == 103 | CategoryId == 104 || CategoryId == 105 || CategoryId == 106 || CategoryId == 107)
            {
                lstNotId = "";
                PageSize = 12;
            }    
