...
namespace WebMVC4.Controllers
{
    public class PodcastController : Controller
    {
        ...
        public ActionResult Index(int Id =0)
        {
            ...
            if (Id == 0x0)
            {
                newsobj = new ContentBO().GetHotNews(59, 1).FirstOrDefault<CONTENT_FULL>();
        ...
        public ActionResult LoadVideo(int VideoId, int page)
        {
            ...
            List<CONTENT_FULL> list = new ContentBO().GetPageContentFullsFrontend(page, pageSize, 59, ref totalRecords, "", "", "", lstNotId, "", -1, 0);
