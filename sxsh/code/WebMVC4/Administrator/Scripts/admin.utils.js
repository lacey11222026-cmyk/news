...
function LoadRichTextEditor(elm, w, h, th, b2, b3, b4) {
    ...
    var _b2 = "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,removeformat,table,help,code,|,insertdate,inserttime,preview,|,forecolor,backcolor";
    ...
    tinyMCE.init({
        ...
        height: _h,
        theme: _th,
        plugins: "ajaxUpload,media,table",
