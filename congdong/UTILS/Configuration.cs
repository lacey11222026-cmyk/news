...
namespace UTILS
{
    public class Configuration
    {
        ...
        public static string HomeConnectionString
        {
            get { return GetConnectionString("shoponlineconn"); }
        }
        public static string ViaConnectionString
        {
            get { return GetConnectionString("viaconn"); }
        }
        ...
        {
            return ConfigurationManager.ConnectionStrings[nameConnection] == null ? string.Empty : ConfigurationManager.ConnectionStrings[nameConnection].ConnectionString;
        }
    }
