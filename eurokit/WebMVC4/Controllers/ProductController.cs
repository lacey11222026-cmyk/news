...
namespace WebMVC4.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult TopProduct2(int top, int categoryId)
        {

            var lstdata = new ProductBO().GetTopProduct(top, -1, -1, 1, null, true);
        ...
        public ActionResult RelateProduct(int id, int categoryId, int manuid)
        {
            try
            {
                var lstdata = new ProductBO().GetTopProduct(10, categoryId, manuid, 1, null, null, "");
