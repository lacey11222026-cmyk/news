...
namespace WebMVC4.Controllers
{
    ...
    public class AdminNews2Controller : Controller
    {
        ...
        public ActionResult GetNewsDetail(int Id = 0)
        {
            ...
            var model = new CONTENT_FULL { PublishDate = DateTime.Now, Id = 0, Alias = HttpContext.User.Identity.Name, CategoryId = 0, Hits = 0,Status=4, CreatedBy = HttpContext.User.Identity.Name,FileParam=new FileInfo() };
        ...
        public ActionResult SaveData(CONTENT_FULL newsobj)
        {
            ...
            {
                newsobj.Url = Utils.ConvertToRewriteLink(newsobj.Title);
            }    
