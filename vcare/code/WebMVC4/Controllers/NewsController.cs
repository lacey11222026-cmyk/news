...
namespace WebMVC4.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(int CategoryId,int Page=1,int Type=0)
        {
            ...
            var siteTitle = cateobj.Name +" - "+Resources.Global.SiteTitle;
            var metaKeyword = siteTitle.Replace(" | ", ",");
            ViewBag.SiteDescription = metaDescription + " " + Utils.StripHtmlTag(ConfigurationManager.AppSettings["DefMetaDescription"]);
        ...
        public ActionResult Detail(string url)
        {
            ...
            var newsobj = new ContentBO().GetFullByUrl(url);
            if (newsobj == null || newsobj.Status !=4 )
                return RedirectToAction("Error", "Home");
            ...
            var lstRef = GetRefArticle(newsobj.Params, newsobj.Id);
            ...
            new ContentBO().ViewAdd(newsobj.Id);
