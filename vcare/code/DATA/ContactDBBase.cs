...
namespace DATA
{
    public abstract class ContactDBBase : ShopOnlineDBBase
    {
        ...
        public abstract IEnumerable<Contact> GetContacts(string lstContactIds);
        ...
        public abstract IEnumerable<Contact> GetAllContacts( int categoryId,int status, string name);
