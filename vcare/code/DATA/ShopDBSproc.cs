    ...
    public class ShopDBSproc : ShopDBBase
    {
        ...
        public override int CreateUpdateShop(Shop manufactory)
        {
            ...
            try
            {
                ...
                string _Latitude = manufactory.Latitude;
                string _Longitude = manufactory.Longitude;
                ...
                {
                    datacontext.SP_Shop_InsertUpdate(_id, _name, _address, _description,_phone, _Longitude, _Latitude, _cityId,0, _cityName, "", _order, _status, ref responecode);
        ...
        public override IEnumerable<Shop> GetAllPaged(int pageIndex, int pageSize, ref int totalRecords, int? published)
        {
