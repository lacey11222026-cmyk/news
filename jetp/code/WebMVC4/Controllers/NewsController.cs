...
namespace WebMVC4.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(int CategoryId, string CateName, int Page = 1, int Type = 0)
        {
            ...
            if (string.IsNullOrEmpty(cateobj.Param.Image))
                cateobj.Param.Image = "/Content/images/bg-intro-1.png";
            ...
            //var lstHotNews = new ContentBO().GetHotNews(CategoryId, 3);
            ...
            //}
            var PageSize = 12;
            //if (CategoryId == 69 || CategoryId == 63 || CategoryId == 80 || CategoryId == 95 || CategoryId == 81 || CategoryId == 91 || CategoryId == 92)
            //{
            //    lstNotId = "";
            //    PageSize = 12;
            //}    
        ...
        public ActionResult Search(string q = "", string fromdate = "", string todate = "", int categoryId = -1, int Page = 1)
        {
            ...
            int total = 0;
            var articles = new ContentBO().GetPageContentFullsFrontend(Page, pageSize, -1, ref total, fromdate, todate, q, "", "", -1, -1);
        ...
        public ActionResult Detail(int Id, string Title)
        {
            ...
            var asynSendNoti = addview.BeginInvoke(Id, 1, null, null);
            try
            {
                newsobj.FileParam = JsonConvert.DeserializeObject<FileInfo>(newsobj.Thumbnail);
            }
        ...
        public ActionResult DownloadFile(int Id)
        {
            ...
            Action<int, int> addview = ViewAdd;
            var asynSendNoti = addview.BeginInvoke(Id, 2, null, null);
            return Redirect(newsobj.FileParam.Path1);
        }
        ...
        public ActionResult RightLastestNews( int MaxLastestNews = 0, string lang="")
        {
            if (MaxLastestNews == 0)
            {
