...
namespace UTILS
{
    public class Utils
    {
        ...
        public static string ConvertToRewriteLink(string text)
        {
            ...
            {
                strReturn = strReturn.Substring(0, 200);
                    ...
                    case "Articles":
                        if (isEnableURLRewrite > 0)
                        {
                            if (id > 0)
                            {
                                ...
                                //if (id == 42)
                                //    return "/chuyen-gia-CNSH-CNTP.html";
        ...
        public static string RemoveVietnameseAccents(string input)
        {
            ...
            // Chuyển thành dạng FormD (dạng tổ hợp ký tự)
            ...
            // Trả lại dạng chuẩn FormC (chuẩn hóa ký tự)
