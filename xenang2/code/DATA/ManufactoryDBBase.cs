...
namespace DATA
{
    public abstract class ManufactoryDBBase: ShopOnlineDBBase
    {
        ...
        public abstract IEnumerable<Manufactory> GetAllManufactoriesPaged (int categoryId, int pageIndex, int pageSize, ref int totalRecords, int published );
        public abstract IEnumerable<Manufactory> GetManufactorysDyn ( string select, string where, string orderBy );
        public abstract IEnumerable<Manufactory> GetAllManufactories(int categoryId, int published);
