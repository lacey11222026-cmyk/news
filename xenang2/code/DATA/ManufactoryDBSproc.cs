...
namespace DATA
{
    public class ManufactoryDBSproc: ManufactoryDBBase
    {
        ...
        public override int CreateUpdateManufactory ( Manufactory manufactory )
        {
            try
            {
                ...
                using ( ShopOnlineDataContext datacontext = DataContext )
                    return datacontext.sp_Manufactory_InsertUpdate ( _id, _title, _description, _image, _website, _published, _ordering, _categoryId, _params );
        ...
        public override IEnumerable<Manufactory> GetAllManufactoriesPaged (int categoryId, int pageIndex, int pageSize, ref int totalRecords, int published )
        {
        ...
        public override IEnumerable<Manufactory> GetAllManufactories (int categoryId,  int published)
        {
            var select = "*";
            var where = string.Empty;
            if (published >= 0)
