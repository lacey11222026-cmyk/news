...
namespace WebMVC4.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //ViewBag.IsMobile2 = mobileHelper.DetectMobileQuick();
            //ViewBag.Android = mobileHelper.DetectAndroid();


            //ViewBag.data = System.Web.HttpContext.Current.Request.ServerVariables["HTTP_USER_AGENT"].ToString();
