...
namespace BIZ
{
    public class QABO
    {
        ...
        public List<QA> GetQAsPaged(int pageIndex, int pageSize, ref int totalRecords, int? published)
        {
            var data = QADBBase.Create().GetAllPaged(pageIndex, pageSize, ref  totalRecords, published);
            if (data == null)
                return null;
