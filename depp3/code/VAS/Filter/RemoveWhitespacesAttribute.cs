...
namespace VAS.Filter
{
    public class RemoveWhitespacesAttribute : ActionFilterAttribute, IActionFilter
    {
        void IActionFilter.OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (!filterContext.HttpContext.Request.RawUrl.Contains("Content")&&!filterContext.HttpContext.Request.RawUrl.Contains("Adminisrator"))
            {
