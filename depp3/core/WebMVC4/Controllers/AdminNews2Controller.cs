...
namespace WebMVC4.Controllers
{
    ...
    public class AdminNews2Controller : Controller
    {
        ...
        protected override void Initialize(RequestContext requestContext)
        {
            ...
            //_staticCategoryByUserList = _staticCategoryList;
        ...
        public ActionResult GetNewsDetail(int Id = 0)
        {
            ...
            if (Id > 0)
            {
                ...
                if (String.IsNullOrEmpty(model.FileParam.Time))
                    model.FileParam.Time = DateTime.Now.ToString("dd/MM/yyyy HH:mm");
        ...
        public ActionResult SaveData(CONTENT_FULL newsobj, string actionType, string note)
        {
            ...
            //newsobj.FileParam.Time = DateTime.ParseExact(newsobj.FileParam.sTime, "dd/MM/yyyy HH:mm", culture);
