...
namespace WebMVC4.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult BannerBottom2(string lang = "vi-vn")
        {
            var lstBanner = new List<DATA.Banner>();
            if (lang == "vi-vn")
                lstBanner = new BannerBO().GetTopLastestBanners(0, 6, 1);
            else
                lstBanner = new BannerBO().GetTopLastestBanners(0, 14, 1);
            return PartialView(lstBanner);
        }
        ...
        public ActionResult BannerTop(int Type)
        {
            var lstBanner = new List<DATA.Banner>();
            
                lstBanner = new BannerBO().GetTopLastestBanners(0, 17,1, Type);
        ...
        public ActionResult TopDocument2(int CategoryId)
        {
            var MaxDocuments = 6;
            var lstcontent = new DocumentBO().GetTopLastestDocumentsFull(MaxDocuments, CategoryId);
            return PartialView(lstcontent);
        ...
        public ActionResult Index()
        {
            ...
            var listNew = new List<BIZ.Entity.CONTENT_FULL>();
            if(langpage=="vi-vn")
            {
                var lstid = new SystemConfigBO().GetValueByKey("HotNewsForCate_0");
                listNew = new ContentBO().GetTopContentByIdsFulls(lstid, 0, true);
            }
            else
            {
        ...
        public ActionResult TopMission2(string lang = "vi-vn")
        {
            //var lstBanner = new List<MISSION_FULL>();

            var lstBanner = Mission2DAL.GetTop();
