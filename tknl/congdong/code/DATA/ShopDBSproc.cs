    ...
    public class ShopDBSproc : ShopDBBase
    {
        ...
        public override int CreateUpdateShop(Shop manufactory)
        {
            ...
            try
            {
                ...
                string _images = manufactory.Images;
                string _email = manufactory.Email;
                string _fax = manufactory.Fax;
                string _addressEn = manufactory.AddressEn;
                ...
                {
                    datacontext.SP_Shop_InsertUpdate(_id, _name, _address, _nameen, _phone, _fax, _url, _type, _addressEn, _images, _email, _order, _status, ref responecode);
        ...
        public override IEnumerable<Shop> GetAllPaged(string keyword, int pageIndex, int pageSize, ref int totalRecords, int? published, string lang,int type)
        {
            ...
            if (!string.IsNullOrEmpty(keyword))
            {
                ...
                where += "OR [AddressEn] LIKE N'%" + keyword + "%' ";
                where += "OR [NameEn] LIKE N'%" + keyword + "%' ";
