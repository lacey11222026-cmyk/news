    ...
    public class ProviderDAL
    {
        public static List<Provider> SelectDynamicPage(string select, string where, string order, int CurrPage, int PageSize, ref int TotalRecord)
        {
            try
            {
                ...
                var list = new DBHelper(Configuration.HomeConnectionString).GetListSP<Provider>("sp_Provider_SelectPagedDynamic", pars);
        ...
        public static List<Provider> SelectDynamic(string select, string where, string order)
        {
            try
            {
                ...
                var list = new DBHelper(Configuration.HomeConnectionString).GetListSP<Provider>("sp_Provider_SelectDynamic", pars);
        ...
        public static int InsertUpdate(Provider functions)
        {
            try
            {
                ...
                new DBHelper(Configuration.HomeConnectionString).ExecuteNonQuerySP("sp_Provider_InsertUpdate", pars);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        public static int UpdateStatus(int Id)
        {
            try
            {
                ...
                new DBHelper(Configuration.HomeConnectionString).ExecuteNonQuerySP("SP_ProviderUpdateStatus", pars);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        public static int UpdateSortOrder(int Id, bool upOrder)
        {
            try
            {
                ...
                new DBHelper(Configuration.HomeConnectionString).ExecuteNonQuerySP("SP_Provider_UpdateSortOrder", pars);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        public static int Delete(int Id)
        {
            try
            {
                ...
                new DBHelper(Configuration.HomeConnectionString).ExecuteNonQuerySP("SP_Provider_Delete", pars);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        public static List<Provider> GetSearch(int status,string keyword, int pageIndex, int pageSize, ref int totalRecords, string Province)
        {
            var select = "*";
