...
namespace DATA
{
    public abstract class ContentDBBase : ShopOnlineDBBase
    {
        ...
        public abstract IEnumerable<Content> GetFilterContentsFrontend(int pageIndex, int pageSize, string title, int categoryId, ref int totalRecords, string fromdate, string todate, string lstNotId, string lang, int type, int isHot);
        public abstract IEnumerable<Content> GetTopLastestContents(int top, int categoryId, string lang = "", int isHot = 0);
