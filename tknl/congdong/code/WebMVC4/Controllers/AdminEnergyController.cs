...
namespace WebMVC4.Controllers
{
    ...
    public class AdminEnergyController : Controller
    {
        //
        // GET: /AdminEnergy/
        ...
        {
            ViewBag.Title = "Danh sách người quản lý năng lượng";
            return View();
        }
        public ActionResult ListEnergy(int? status, int? currentPage, int? pageSize, string lang, int? type)
        {
            ...
            data = AuditorDAL.GetSearch(Status, "", CurrPage, RecordPerPage, ref TotalRecord, 2,"");
            if (data != null)
