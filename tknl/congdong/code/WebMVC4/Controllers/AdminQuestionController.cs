...
namespace WebMVC4.Controllers
{
    ...
    public class AdminQuestionController : Controller
    {
        ...
        public ActionResult ListQA(int? status, int? currentPage, int? pageSize,string lang)
        {
            ...
            data = new QABO().GetQAsPaged(CurrPage, RecordPerPage, ref TotalRecord, Status,lang);
            if (data!=null)
        ...
        [ValidateInput(false)]
        [HttpPost]
        public JsonResult SaveData(QA QA)
        {
