...
{
    public class Podcast2Controller : Controller
    {
        //
        // GET: /Video/
        ...
        public ActionResult Index(int Id = 0)
        {
            ...
            if (Id == 0x0)
            {
                newsobj = new ContentBO().GetHotNews(9, 1).FirstOrDefault<CONTENT_FULL>();
        ...
        public ActionResult LoadVideo(int VideoId, int page)
        {
            ...
            List<CONTENT_FULL> list = new ContentBO().GetPageContentFullsFrontend(page, pageSize, 9, ref totalRecords, "", "", "", lstNotId, "", -1, 0);
