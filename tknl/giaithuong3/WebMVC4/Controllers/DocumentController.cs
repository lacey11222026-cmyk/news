...
namespace WebMVC4.Controllers
{
    public class DocumentController : Controller
    {
        ...
        public ActionResult Index(int Id, string fromdate="", string todate="", string keyword="",string code="",string year="", int agent = 0, int area = 0, int type = 0, int Page = 1)

        {
            ...
            data = new DocumentBO().GetDocumentsSearchPaged2(keyword.Trim(),year.Trim(),agent,area,type, Id, 1, Page, PageSize, fromdate, todate, ref Total);
