...
namespace Static
{
    ...
    public class srv_thumb : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (_width < 0 || _width > 1280) _width = 400;
            if (_height < 0 || _height > 1280) _height = 400;

            if (!MvcApplication.ImageWidth.Contains("," + _width + ",") || !MvcApplication.ImageHeight.Contains("," + _height + ","))
            {
                context.Response.Write("Kích thước ảnh không đúng!");
            }
