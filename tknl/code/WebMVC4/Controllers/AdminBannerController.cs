...
namespace WebMVC4.Controllers
{
    ...
    public class AdminBannerController : Controller
    {
        ...
        public ActionResult ListBanner(int? regionId, int? status, int? type, int? categoryId)
        {
            ...
            var data = new BannerBO().GetTopLastestBanners(0, RegionId, Status, Type, CategoryId);
            ...
            try
            {
                ...
                if (result >= 0)
                {
                    ...
                    if (banner.Id > 0)
                    {
                        ...
                        lognewsobj.Description = "Update Banner";
                    }

                    else
                    {
                        ReturnData.Description = "Thêm mới Thành Công";
                        lognewsobj.Description = "Tạo mới Banner";
                    }
            ...
            try
            {
                if (Id > 0)
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        {
                            obj.Status = 0;
                            lognewsobj.Description = "Khóa banner";
                        }
