...
// maxheight
	$(function(){
		...
		$('.maxheight38').matchHeight();
		$('.maxheightimg38').matchHeight();
		$('.maxheight39').matchHeight();
		$('.maxheightimg39').matchHeight();
		$('.maxheight40').matchHeight();
		$('.maxheightimg40').matchHeight();
		$('.maxheight41').matchHeight();
		$('.maxheightimg41').matchHeight();

		$('.maxheight15').matchHeight();
		$('.maxheightimg15').matchHeight();
