    ...
    public class ProductDBSproc : ProductDBBase
    {
        ...
        public override int CreateUpdateProduct(Product manufactory)
        {
            ...
            try
            {
                ...
                string _tech = manufactory.QRImage;
                ...
                {
                    datacontext.SP_Product_InsertUpdate(_id, _name, _description, _intro, _tech, _service, _image, _album, _config, _ishot, _isnew, _price, _priceReal, _availableSell, _status, _order, _manufactoryId, _cateId, _catepath, ref responecode);
        ...
        public override IEnumerable<Product> GetAllPaged(string keyword, int categoryId, int manufactoryId, int pageIndex, int pageSize, ref int totalRecords, int? published, bool? isHot, bool? isNew, string lang = "",int min=0,int max=0,int orderType=0)
        {
            ...
            if (!string.IsNullOrEmpty(keyword))
            {
                ...
                where += "OR Config LIKE N'%" + keyword + "%' )";
