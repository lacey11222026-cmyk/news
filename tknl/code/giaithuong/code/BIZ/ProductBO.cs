...
namespace BIZ
{
    public class ProductBO
    {
        ...
        public List<Product_Full> GetTopContentByIdsFulls(string ids, int top, bool isArragne = false)
        {
        ...
        public List<Product_Full> GetTopProduct(int top, int categoryId, int manufactoryId, int? published, bool? isHot, bool? isNew, string lang = "")
        {
            var data = ProductDBBase.Create().GetTopLastest(top, categoryId, manufactoryId,published, isHot, isNew,lang);
            if (data == null)
                return null;
            var lstData = new List<Product_Full>();
        ...
        public List<Product_Full> GetProductsPaged(string keyword, int categoryId,int manufactoryId, int pageIndex, int pageSize, ref int totalRecords, int? published, bool? isHot, bool? isNew, string lang = "",int min=0,int max=0,int orderType=0)
        {
