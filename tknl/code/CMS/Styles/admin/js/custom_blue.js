...
//                $(this).css("top", a - 24 + "px");
//                $(this).css("left", b + 60 + "px")
//            }
//        }
//    });
...
$(function () {
    ...
    //});
    //$(function () {
    //    $("table#graph_data td").click(function () {
    //        if (!$(this).is(".input") && $(this).attr("class") != "no_input hover") {
    //            $(this).addClass("input").html('<input type="text" value="' + $(this).text() + '" size="4" />').find("input").focus().blur(function () {
