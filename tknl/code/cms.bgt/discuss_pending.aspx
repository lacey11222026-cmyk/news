<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" Inherits="CMS.discuss_pending" CodeBehind="discuss_pending.aspx.cs" %>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr valign="top">
                                    ...
                                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif'); padding-top: 3px; padding-left: 5px; color: #ffffff"
                                        id="tdParentTitle">
                                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Tin bài chờ"></asp:Literal>
                                    </td>
                                    <td style="width: 10px">
                                                    ...
                                                    <td align="center">
                                                        <table cellpadding="1" cellspacing="1" border="0" class="text">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <asp:DropDownList ID="ddlDiscuss" runat="server" 
                                                                ...
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1" style="background-color: #E8EDF6"
                                                                    ...
                                                                    <tr class="header">
                                                                        ...
                                                                        <td align="center" style="width: 45px">
                                                                            <asp:Literal ID="ltlHeaderMoveUp" runat="server" Text="Gủi lên"></asp:Literal>
                                                                        </td>
                                                                        <td align="center" style="width: 45px">
