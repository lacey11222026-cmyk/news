<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" Inherits="CMS.discuss_edit" CodeBehind="discuss_edit.aspx.cs" %>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr valign="top">
                                    ...
                                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif'); padding-top: 3px; padding-left: 5px; color: #ffffff"
                                        id="tdParentTitle">
                                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Cập nhật giao lưu"></asp:Literal>
                                    </td>
                                    <td style="width: 10px">
                                                    ...
                                                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="AjaxLoadingPanel1">
                                                        <table cellpadding="1" cellspacing="1" border="0" class="text">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlDiscuss" runat="server" DataTextField="Title" DataValueField="DiscussId"
                                                                        AutoPostBack="true" Width="540px" OnSelectedIndexChanged="ddlDiscuss_SelectedIndexChanged" OnDataBound="ddlDiscuss_DataBound">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Literal ID="ltlReaderInfo" runat="server"></asp:Literal>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="padding-right: 5px;">
                                                                <asp:HiddenField runat="server" ID="hfCurrStatus" Value="0"/>
                                                                ...
                                                                &nbsp;&nbsp;
                                                                    <asp:Button ID="btnUpdateAndMoveUp" runat="server" CssClass="button"
                                                                        Text="Ghi & Gửi lên" OnClick="btnUpdateAndMoveUp_Click" />&nbsp;&nbsp;
