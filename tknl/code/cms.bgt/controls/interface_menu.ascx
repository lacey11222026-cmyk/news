<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMS.controls_interface_menu" Codebehind="interface_menu.ascx.cs" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr valign="top">
                    ...
                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif');
                        padding-top: 3px; padding-left: 5px; color: #ffffff">
                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Quản lý giao diện"></asp:Literal>
                    </td> 
                    <td align="right" style="background-image: url('<%# UrlRoot %>images/top2.gif');
                        padding-top: 2px"><img alt="Thu nhỏ" id="imgDecrease" style="cursor: hand; cursor: pointer" onclick="Decrease()"
