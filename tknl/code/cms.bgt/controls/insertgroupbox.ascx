<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CMS.controls_insertgroupbox" Codebehind="insertgroupbox.ascx.cs" %>
...
<script type="text/javascript">
    ...
    function OK_Clicked() {
        ...
        var sBackground = document.getElementById("txtBackground_Color").value;
        ...
        arg.returnExtension = sWidth + '|' + sAlign + '|' + sBackground;
        oWindow.Close(arg);
    }
...
<fieldset>
    ...
    <table style="width: 100%" cellpadding="1" cellspacing="1" class="text">
        <tr>
            ...
            <td>
                <textarea  id="txtTitle" style="width: 250px; height: 200px;" cols="40" rows="5"></textarea>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" id="txtWidth" value="100" style="width: 200px" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td nowrap>
                <input type="text" id="txtBackground_Color" value="#f2f2f2" style="width: 200px" />&nbsp;<img alt=""
                    id="imgBackColor" src="<%# UrlRoot%>icons/BackColor.gif" style="cursor: pointer"
                    onclick="ColorPicker('imgBackColor','txtBackground_Color')" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
