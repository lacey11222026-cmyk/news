...
namespace CMS
{
    public partial class controls_documentmanager : System.Web.UI.UserControl
    {
        public string UrlRoot = DBCommon.UrlRoot;
        private UserValidation m_UserValidation = new UserValidation();

        private string documentsFilters = Constants.documentFileTypes;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                ltldocumentsFilters.Text = ltlMultiUploaddocumentsFilters.Text = "Hệ thống chỉ cập nhật các file có định dạng sau: " + documentsFilters;
                BindData(1);
            }
        }
        ...
        protected void BindData(int CurrPage)
        {
            ...
            int TotalRecord = 0;
            rptData.DataSource = m_FileManager.GetPaged(m_UserValidation.LoginID, FileManager.FileType.Document, Keyword, FromDate, ToDate, CurrPage, RecordPerPage, out TotalRecord);
            rptData.DataBind();
            if (TotalRecord > 0)
            {
        ...
        protected void rptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemIndex != -1 && e.Item.ItemType != ListItemType.Separator)
            {
                ...
                if (item != null)
                {
                    ...
                    hlName.Attributes.Add("onclick", "OK_Clicked('" + FilePath + item.Name + "','" + sDescription + "')");
        ...
        protected void btPost_Click(object sender, EventArgs e)
        {
            ...
            if (oFile.ContentLength > 0)
            {
                ...
                if (documentsFilters.IndexOf(Extension) >= 0)
                {
                    Name = oFile.GetName();
                    ...
                    m_FileManager.Type = (int)FileManager.FileType.Document;
                ...
                sb.AppendLine("arg.returnExtension = '" + Description + "';");
