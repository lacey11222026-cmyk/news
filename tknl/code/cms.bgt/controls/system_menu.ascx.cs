...
namespace CMS
{
    public partial class controls_system_menu : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                DataTable dt = lang.GetPage("ADMIN_SYSTEM_PAGES", "priority ASC");
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    if (m_UserValidation.CheckSysFunction(Convert.ToInt32(dr["FuncID"])))
                    {
                        ...
                        dtChild = lang.GetPage("ADMIN_SYSTEM_" + dr["key"].ToString().ToUpper() + "_PAGES", "priority ASC");
