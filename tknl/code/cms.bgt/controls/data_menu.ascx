<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMS.controls_data_menu" Codebehind="data_menu.ascx.cs" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr valign="top">
                    ...
                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif');
                        ...
                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Thống kê tin bài"></asp:Literal>
                    </td>
