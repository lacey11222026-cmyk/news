<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="mp3manager.ascx.cs"
    Inherits="CMS2012.controls.mp3manager" %>
                            ...
                            <table cellpadding="1" cellspacing="1" border="0" class="text">
                                <tr>
                                    ...
                                    <td align="left" style="width: 150px">
                                        <telerik:RadDateTimePicker ID="txtDateFrom" runat="server" Skin="Default" DateInput-DateFormat="dd/MM/yyyy HH:mm:ss"
                                    ...
                                    <td align="left" style="width: 150px">
                                        <telerik:RadDateTimePicker ID="txtDateTo" runat="server" Skin="Default" DateInput-DateFormat="dd/MM/yyyy HH:mm:ss"
                                            DateInput-DisplayDateFormat="dd/MM/yyyy HH:mm:ss">
                                        </telerik:RadDateTimePicker>
                                    </td>
                                </tr>
    ...
    <telerik:RadPageView ID="RadPageView2" runat="server" Selected="true">
        ...
        <fieldset>
            ...
            <table width="98%" align="center" cellpadding="0" cellspacing="0" border="0" class="text">
                <tr>
                    <td colspan="2">
                        <asp:Literal ID="ltlmediaFilters" runat="server" Text="Hệ thống chỉ cập nhật các file có định dạng sau: .flv .avi .mpg .dat .vob .3gp .wmv .asf .mp4 .mov .3gp và tự động Convert sang định dạng .flv"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbxDescription" runat="server" TextMode="MultiLine" Width="220px"
