<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMS.controls_discuss_menu" Codebehind="discuss_menu.ascx.cs" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr valign="top">
                    ...
                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif'); padding-top: 3px;
                        ...
                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Quản lý giao lưu"></asp:Literal></td>
