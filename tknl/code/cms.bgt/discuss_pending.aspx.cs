...
namespace CMS
{
    ...
    public partial class discuss_pending : System.Web.UI.Page
    {
        ...
        private const int RecordPerPage = 30;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                if (l_Discuss != null && l_Discuss.Count > 0)
                {
                    ...
                    ddlDiscuss.DataTextField = "Title";
                    ddlDiscuss.DataValueField = "DiscussId";
                    ddlDiscuss.DataBind();
        ...
        protected void BindData()
        {
            ...
            if (m_Workflows != null)
            {
                LTL_HEADER.Text = "Danh sách chờ " + m_Workflows.Description.ToLower();
                Status = m_Workflows.Status;
            }
            DiscussId = int.Parse(ddlDiscuss.SelectedValue);
            ...
            int TotalRecord = 0;
            rptData.DataSource = m_ReaderDiscuss.GetPagedPending(DiscussId, GuestId, Status, FromDate, ToDate, CurrPage, RecordPerPage, out TotalRecord);
            rptData.DataBind();
            if (TotalRecord > 0)
            {
        ...
        protected void rptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemIndex != -1 && e.Item.ItemType != ListItemType.Separator)
            {
                ...
                if (item != null)
                {
                    ...
                    iBtnMoveUp.Enabled = m_Workflows.MoveUp > -1 ? true : false;
                    ...
                    iBtnMoveDown.Enabled = m_Workflows.MoveDown > -1 ? true : false;
        ...
        protected void iBtnMoveDown_Click(object sender, EventArgs e)
        {
            ...
            if (iBtn != null)
            {
                ...
                m_Workflows.Id = TaskID;
                m_Workflows = m_Workflows.Get();
                new DiscussDetail { Id = long.Parse(iBtn.CommandArgument), Status = m_Workflows.MoveDown }.UpdateStatus();
                BindData();
            }
        }
