<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" Inherits="CMS.service_discuss_edit" CodeBehind="service_discuss_edit.aspx.cs" %>
                                                    ...
                                                    <td>
                                                        <table cellpadding="1" cellspacing="1" border="0" class="text">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HiddenField ID="hfDiscussId" runat="server" />
    ...
    <script type="text/javascript">
        ...
        Telerik.Web.UI.Editor.CommandList["CustomImageManager"] = function (commandName, editor, args) {
            var myCallbackFunction = function (sender, args) {
                ...
                //imgExtension[5]  '" />';
                //editor.pasteHtml('<TABLE cellSpacing=0 cellPadding=3 width=1 border=0 align=' + imgExtension[5] + '><TR><TD>' + sImg + '</TD></TR><TR><TD class=Image align=left>abc</TD></TR></TABLE>');
