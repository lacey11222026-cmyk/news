<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" Inherits="CMS.service_discuss_reader" Codebehind="service_discuss_reader.aspx.cs" %>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr valign="top">
                                    ...
                                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif');
                                        ...
                                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Kiểm duyệt câu hỏi"></asp:Literal>
                                    </td>
                                    <td style="width: 10px">
                                                ...
                                                <tr valign="top">
                                                    <td>
                                                        <asp:Repeater ID="rptData" runat="server" 
                                                            OnItemDataBound="rptData_ItemDataBound" onitemcreated="rptData_ItemCreated">
                                                            <HeaderTemplate>
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1" style="background-color: #E8EDF6"
                                                                    ...
                                                                    <tr class="header">
                                                                        ...
                                                                        <td style="width:30px">
                                                                            <asp:Literal ID="ltlHeaderAge" runat="server" Text="Tuổi"></asp:Literal>
                                                                        </td>
                                                                        <td style="width:120px">
                                                                            <asp:Literal ID="ltlHeaderAddress" runat="server" Text="Địa chỉ"></asp:Literal>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Literal ID="ltlHeaderQuestion" runat="server" Text="Câu hỏi"></asp:Literal>
                                                                        </td>
                                                                        <td align="center" style="width: 60px">
                                                                            <asp:Literal ID="ltlHeaderStatus" runat="server" Text="Gửi lên"></asp:Literal>
                                                                        </td>
                                                                    </tr>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <tr class="item" id="trItem" runat="server">
                                                                    ...
                                                                    <td>
                                                                        <asp:Literal ID="ltlGender" runat="server" Text="Giới tính"></asp:Literal>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Literal ID="ltlAge" runat="server" Text="Tuổi"></asp:Literal>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Literal ID="ltlAddress" runat="server" Text="Địa chỉ"></asp:Literal>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Literal ID="ltlQuestion" runat="server" Text="Câu hỏi"></asp:Literal>
                                                                    </td>
                                                                    <td align="center">
                                                                        <asp:ImageButton ID="iBtnStatus" runat="server" BorderWidth="0" Visible="false" />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
