<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" Inherits="CMS.system_user_add" Title="Untitled Page" CodeBehind="system_user_add.aspx.cs" %>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr valign="top">
                                    ...
                                    <td class="title" style="background-image: url('<%# UrlRoot %>images/top2.gif'); padding-top: 3px; padding-left: 5px; color: #ffffff"
                                        id="tdParentTitle">
                                        <asp:Literal ID="LTL_HEADER" runat="server" Text="Thêm mới người dùng"></asp:Literal></td>
                                    <td style="width: 10px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <fieldset>
                                                                        ...
                                                                        <div style="width: 375px; height: 150px; overflow: auto; text-align: justify">
...
function OnRequestStart(sender, args)
{
    if(args.EventTarget.indexOf("btnAdd") >= 0)
    {
       if(document.getElementById("<%# txtUsername.ClientID %>").value == "")
        ...
        var PassValue = document.getElementById("<%# txtPass.ClientID %>").value;
        if(PassValue == "")
        {
        ...
        var ConfirmPassValue = document.getElementById("<%# txtConfirmPass.ClientID %>").value;
         if(ConfirmPassValue == "")
        {
            alert("Phải nhập lại mật khẩu!"); 
