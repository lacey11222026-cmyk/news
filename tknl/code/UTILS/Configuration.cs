...
namespace UTILS
{
    public class Configuration
    {
        ...
        private static string GetConnectionString(string nameConnection) =>
           (ConfigurationManager.ConnectionStrings[nameConnection] == null) ? string.Empty : ConfigurationManager.ConnectionStrings[nameConnection].ConnectionString;

        public static string SMSConnectionString =>
           GetConnectionString("shoponlineconn");
