    ...
    public class SupportBO
    {
        ...
        public SUPPORT_FULL GetSupportFull(int supportId)
        {
            try
            {
                ...
                if (data != null)
                    return JsonConvert.DeserializeObject<SUPPORT_FULL>(data.ToString());

                var support = GetSupport(supportId);

                var item = new SUPPORT_FULL
                {
        ...
        public void UpdateCache(SUPPORT_FULL supportFull)
        {
            ...
            delegateUpdateCache.BeginInvoke(strKeyCached, JsonConvert.SerializeObject(supportFull), null, null);
