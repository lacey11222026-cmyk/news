...
namespace BIZ
{
    public class CategoryBO
    {
        ...
        public int UpdateContent(Category itemBase)
        {
            ...
            var result = CategoryDBBase.Create().UpdateContent(itemBase.Id, itemBase.Contents, itemBase.Published, itemBase.Ordering, itemBase.Language);
            if (result != -1)
            {
        ...
        public int UpdateContentFull(CATEGORY_FULL categoryFull)
        {

            
            var result = CategoryDBBase.Create().UpdateContent(categoryFull.Id, categoryFull.Contents, categoryFull.Published, categoryFull.Ordering, categoryFull.Language);
            if (result != -1)
            {
        ...
        public CATEGORY_FULL GetCategoryFull(int categoryId)
        {
            try
            {
                ...
                if (data != null)
                    return JsonConvert.DeserializeObject<CATEGORY_FULL>(data.ToString());
            ...
            {
                ExHandler.Handle(e, "CategoryBO", "GetCategoryFull categoryId= " + categoryId);
                return null;
            }
        }
        ...
        public List<CATEGORY_FULL> GetAllCategoriesFull(UTILS.Constants.CategoryType categoryType)
        {
            try
            {
                ...
                //var data = LocalCaching.GetData(strKeyCached);
                //if (data != null)
                //    return JsonConvert.DeserializeObject<List<CATEGORY_FULL>>(data.ToString());
            ...
            {
                ExHandler.Handle(e, "categoryBo", "GetAllCategoriesFull");
                return null;
            }
        }
        ...
        public List<CATEGORY_FULL> GetAllCategoriesFullPaged(int pageIndex, int pageSize, ref int totalRecords)
        {
            ...
            {
                ExHandler.Handle(e, "CategoryBO", "GetAllCategoriesFullPaged");
                return null;
            }
        }
        ...
        public List<CATEGORY_FULL> GetAllChildCategories(int categoryId, int numberTake, bool isRandom)
        {
            ...
            //if (data != null)
            //{
            //    lstItem = JsonConvert.DeserializeObject<List<CATEGORY_FULL>>(data.ToString());
            //}

            //var lstItem =LocalCaching.GetData(strKeyCached) as List<CATEGORY_FULL>;
        ...
        public int GetNodeLevel(string pathway)
        {
            ...
            {
                ExHandler.Handle(e, "CategoryBO", "GetNodeLevel");
                return 0;
            }
        }
        ...
        {
            var result = CategoryDBBase.Create().GetAllCategoriesByPosition((byte)UTILS.Constants.CategoryPosition.Homepage, string.Empty);
            if (result == null)
                return null;
        ...
        public List<CATEGORY_FULL> GetAllHomepageCategoryFulls()
        {
            ...
            {
                ExHandler.Handle(e, "CategoryBO", "GetAllHomepageCategoryFulls");
                return null;
            }
        ...
        /// </summary>        
        /// <returns></returns>
        public List<CATEGORY_FULL> GetAllCategoryFullsByPosition(UTILS.Constants.CategoryPosition categoryPosition, int numberTake, bool isRandom, string lang = "")
        {
            var strKeyCached = strGroupKeyCached+"_"+Constants.CACHE_KEY_ALL_CATEGORIES_BY_POSITION + (byte)categoryPosition + "_lang" + lang;
            ...
            var lstItemBase = CategoryDBBase.Create().GetAllCategoriesByPosition((byte)categoryPosition, lang);
        ...
        //    delegateUpdateCache.BeginInvoke(strKeyCached, JsonConvert.SerializeObject(categoryFull), null, null);
