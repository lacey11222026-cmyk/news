...
namespace BIZ
{
    public class ProductBO
    {
        ...
        public List<Product> GetProductsPaged(string keyword, int categoryId,int manufactoryId, int pageIndex, int pageSize, ref int totalRecords, int? published, bool? isHot, bool? isNew, string lang = "",int min=0,int max=0,int orderType=0)
        {
