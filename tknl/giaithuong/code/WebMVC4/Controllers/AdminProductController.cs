    ...
    public class AdminProductController : Controller
    {
        ...
        public ActionResult AddEdit(int? Id)
        {
            ...
            if (PageID > 0)
            {
                ...
                model.Description = Config.Domain + cateobj.Url + Utils.ConvertToRewriteLink(model.Name) + "-" + model.Id;
                try
                {
                ...
                model.ProductParam = JsonConvert.DeserializeObject<ProductParam>(model.Album);
            }
            else
            {
        ...
        [ValidateInput(false)]
        [HttpPost]
        public JsonResult SaveData(Product Product)
        {
            var returnData = new ReturnData();
            ...
            try
            {
                ...
                if (Product.Id > 0)
                {
                    ...
                    Product.Description = Config.Domain + cateobj.Url + Utils.ConvertToRewriteLink(Product.Name) + "-" + Product.Id;
                }    
