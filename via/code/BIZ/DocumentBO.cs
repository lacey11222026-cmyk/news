...
namespace BIZ
{
    public class DocumentBO
    {
        ...
        public List<DOCUMENT_FULL> GetDocumentsSearchPaged(string title, int categoryId,int doctype, int status, int pageIndex, int pageSize, string fromdate, string todate, ref int totalRecords)
        {
            var Documents = DocumentDBBase.Create().GetDocumentsSearch(title, categoryId, doctype, status, pageIndex, pageSize,fromdate,todate, ref totalRecords);
            if (Documents == null)
                return null;
        ...
        public List<DOCUMENT_FULL> GetDocumentsSearchPaged2(string title, string code, int agent, int area, int type, int categoryId, int doctype, int status, int pageIndex, int pageSize, string fromdate, string todate, ref int totalRecords)
        {
            var Documents = DocumentDBBase.Create().GetDocumentsSearch2(title, code, agent, area, type, categoryId, doctype, status, pageIndex, pageSize, fromdate, todate, ref totalRecords);
            if (Documents == null)
                return null;
