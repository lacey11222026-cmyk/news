...
namespace BIZ
{
    public class ProductAttributeBO
    {
        ...
        public PRODUCTATTRIBUTE_FULL GetProductAttributeFull(int productAttributeId)
        {
            ...
            {
                ExHandler.Handle(e, "ProductAttributeBO", "GetProductAttributeFull: productAttributeId=" + productAttributeId);
                return null;
            }
        }
        ...
        public List<PRODUCTATTRIBUTE_FULL> GetProductAttributesByAttribute(int attributeId)
        {
            ...
            {
                ExHandler.Handle(e, "ProductAttributeBO", "GetProductAttributesByAttribute: attributeId=" + attributeId);
                return null;
            }
        ...
        public List<PRODUCTATTRIBUTE_FULL> GetProductAttributesByProduct(int productId)
        {
            ...
            {
                ExHandler.Handle(e, "ProductAttributeBO", "GetProductAttributesByProduct: productId=" + productId);
                return null;
            }
