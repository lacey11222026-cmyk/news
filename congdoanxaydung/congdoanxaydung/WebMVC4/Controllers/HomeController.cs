...
namespace WebMVC4.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult HomeVideo(int CategoryId, string CateName)
        {
            ...
            var lstdata = new ContentBO().GetTopLastestContentFulls(4, 6);
        ...
        public ActionResult Error()
        {
            ...
            if (requestpage.EndsWith(".htm"))
            {
                ...
                //NLogLogger.DebugMessage(newsid);
                return RedirectToAction("Detail", "News", new { Id = int.Parse(newsid), Title = "abc" });
            }
