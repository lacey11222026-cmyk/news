...
namespace DATA
{
    public class DocumentDBSproc: DocumentDBBase
    {
        ...
        public override IEnumerable<Document> GetDocumentsSearch(string keyword, int categoryId, int status, int pageIndex, int pageSize, string fromdate, string todate, ref int totalRecords,string code= "", string des = "", string type = "")
        {
            var select = "*";
