...
namespace WebMVC4.Post
{
    ...
    public class SystemService : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (!HttpContext.Current.User.IsInRole("Administrator") && !HttpContext.Current.User.IsInRole("Rate"))
                {
                ...
                {
                    case "flush":
                        //UTILS.Utils.SetAppSettingValue("cacheall", DateTime.Now.ToString("ddMMyyyyHHmmss"),
