...
$(document).ready(function () {
    if (window.location.host == 'congdoannganhangvn.org.vn' || window.location.host == 'www.congdoannganhangvn.org.vn' || window.location.host == 'cdnganhangvn.org.vn'|| window.location.host == 'www.cdnganhangvn.org.vn'|| window.location.host == 'www.vnubw.org.vn') {
        window.location.href = 'http://vnubw.org.vn/';
    }
