...
namespace WebMVC4.Controllers
{
    public class VideoController : Controller
    {
        ...
        public ActionResult Index(int VideoId = 0)
        {
            ...
            if (VideoId == 0)
            {
                model = new ContentBO().GetTopLastestContentFulls(1, 36).FirstOrDefault();
            }
            else
            {
        ...
        public ActionResult LoadVideo(int VideoId, int page)
        {
            ...
            ViewBag.page = page;
            int total = 0;
            var lst = new ContentBO().GetPageContentFullsFrontend(page, pagesize, 36, ref total, "", "", "", VideoId.ToString(), "", -1);
