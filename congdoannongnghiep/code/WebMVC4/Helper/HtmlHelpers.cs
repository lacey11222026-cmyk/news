...
namespace WebMVC4.Helper
{
    public static class HtmlHelpers
    {
        ...
        public static string GetDocA(string Region)
        {
            string result = "";
            switch (Region)
            {
                ...
                case "8":
                    ...
                    break;
                case "9":
                    result = "Bộ Nông nghiệp và PTNT";
                    break;
                case "10":
                    result = "Công đoàn Nông nghiệp và PTNT VN";
                    break;
                case "11":
                    result = "Nghiệp đoàn Nghề cá Việt Nam";
                    break;
                case "12":
                    result = "Các cơ quan khác";
                    break;
                case "13":
                    result = "Đảng Cộng sản Việt Nam";
                    break;
                default:
                    result = "";
                    break;
        ...
        public static string GetDocType(string Region)
        {
            string result = "";
            switch (Region)
            {
