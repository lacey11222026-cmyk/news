...
namespace BIZ
{
    public class AlbumImageBO
    {
            ...
            try
            {
                ...
                item = new AlbumImage_FULL()
               {
                   ...
                   GroupName = itemBase.GroupName,
                    Description2 = itemBase.Description2,
                    Image2 = itemBase.Image2,
                    Name2 = itemBase.Name2,
                    TotalVote1 = itemBase.TotalVote1,
                    Point1 = itemBase.Point1,
                    TotalVote2 = itemBase.TotalVote2,
                    Point2 = itemBase.Point2,
                };
                        ...
                        foreach (var content in lstItemBase)
                        {
                            if (content.Id == long.Parse(itemid))
                            {
                                var item = new AlbumImage_FULL()
                                {
                                    ...
                                    Name2 = content.Name2,
                                    TotalVote1 = content.TotalVote1,
                                    Point1 = content.Point1,
                                    TotalVote2 = content.TotalVote2,
        ...
        public List<AlbumImage_FULL> GetAlbumsFuLLPaged(string title, int categoryId, int status, int type, int pageIndex, int pageSize, ref int totalRecords, string fromdate = "", string todate = "", string orderBy = "PublishDate DESC")
        {
            ...
            foreach (var item in Albums)
            {
                AlbumImage_FULL AlbumsFull = new AlbumImage_FULL()
                {
                    ...
                    Image2 = item.Image2,
                    Name2 = item.Name2,
                    TotalVote1 = item.TotalVote1,
                    Point1 = item.Point1,
                    TotalVote2 = item.TotalVote2,
                    Point2 = item.Point2,
        ...
        public int Vote2(long albumId, int point)
        {
            var returnVal = AlbumImageDBBase.Create().Vote2(albumId, point);
            if (returnVal != -1)
                FlushAllAlbumCache(string.Empty);
            return returnVal;
        }
