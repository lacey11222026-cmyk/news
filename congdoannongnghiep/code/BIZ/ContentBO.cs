...
namespace BIZ
{
    public class ContentBO
    {
        ...
        private IEnumerable<Content> FilterContents(int pageIndex, int pageSize, string title, int categoryId, List<int> lstcate, int status, string createdby, ref int totalRecords, string fromdate = "", string todate = "", string lststatus = "", string alias = "", int channelId = -1)
        {
            var contents = ContentDBBase.Create().GetFilterContents(pageIndex, pageSize, title, categoryId, lstcate, status, createdby, ref totalRecords, fromdate, todate, lststatus, alias, channelId);
            if (contents == null)
                return null;
            return contents;
        }
        ...
        public List<CONTENT_FULL> GetFilterContentFullsPaged(int pageIndex, int pageSize, string title, int categoryId, List<int> lstcate, int status, string createdby, ref int totalRecords, string fromdate = "", string todate = "", string lststatus = "", string alias = "", int channelId = -1)
        {
            var contents = FilterContents(pageIndex, pageSize, title, categoryId, lstcate, status, createdby, ref totalRecords, fromdate, todate, lststatus, alias, channelId);
            if (contents == null)
                return null;
        ...
        private IEnumerable<Content> GetTopLastestContents(int top, int categoryId,int hot=0)
        {
            var result = ContentDBBase.Create().GetTopLastestContents(top, categoryId, hot);
            if (result == null)
                return null;
            return result;
        }
        ...
        public List<CONTENT_FULL> GetHotNews(int categoryId, int maxLastestNews)
        {
            ...
            var lstItemBase = GetHotNewsPrivate(categoryId, maxLastestNews+1);
            lstItemBase = lstItemBase.Where(x => x.PublishDate <= DateTime.Now).Take(maxLastestNews).ToList();
            if (lstItemBase == null || lstItemBase.Count() == 0)
                return null;
        ...
        public List<CONTENT_FULL> GetPageContentFullsFrontend(int pageIndex, int pageSize, int categoryId, ref int totalRecords, string fromdate = "", string todate = "", string title = "", string lstNotId = "", string lang = "", int type = -1, int channelId = 0)
        {
            string strKeyCached = strGroupKeyCached + "_" + Constants.CACHE_KEY_TOP_LASTEST_CONTENTS_FRONTEND + pageIndex + "_pz" + pageSize + "_cate" + categoryId + "_fd" + fromdate + "_td" + todate + "_t" + title + "_ls" + lstNotId + "_lang" + lang + "_type" + type + "_chid" + channelId;
            string strKeyCachedTotal = strGroupKeyCached + "_" + Constants.CACHE_KEY_TOP_LASTEST_CONTENTS_FRONTEND + pageIndex + "_pz" + pageSize + "_cate" + categoryId + "_fd" + fromdate + "_td" + todate + "_t" + title + "_ls" + lstNotId + "_lang" + lang + "_type" + type + "_total" + "_chid" + channelId;
            ...
            var lstItemBase = ContentDBBase.Create().GetFilterContentsFrontend(pageIndex, pageSize, title, categoryId, ref totalRecords, fromdate, todate, lstNotId, lang, type, channelId);
        ...
        public List<CONTENT_FULL> GetTopLastestContentFulls(int top, int categoryId = 0,int hot=0)
        {
            var strKeyCached = strGroupKeyCached+"_"+Constants.CACHE_KEY_TOP_LASTEST_CONTENTS + top + "_category" + categoryId + "_site" + hot;
            ...
            var lstItemBase = GetTopLastestContents(top, categoryId,hot);
            if (lstItemBase == null || lstItemBase.Count() == 0)
                return null;
        ...
        public List<CONTENT_FULL> GetTopLastestContentFullsNotCache(int top, int categoryId = 0, int site = 0)
        {
