...
namespace BIZ
{
    public class ContentBO
    {
        ...
        private IEnumerable<Content> GetTopLastestContents(int top, int categoryId, string site = "")
        {
        ...
        public List<CONTENT_FULL> GetTopViewContentFulls(int top, int categoryId = 0, string lang = "", string fromdate = "", string todate = "")
        {
            var strKeyCached = strGroupKeyCached + "_" + Constants.CACHE_KEY_TOP_VIEW_CONTENTS + top + "_category" + categoryId + "_title" + lang + "_fr" + fromdate + "_t" + todate;
            ...
            var lstItemBase = GetTopViewContents(top, categoryId, lang, fromdate, todate);
            if (lstItemBase == null || lstItemBase.Count() == 0)
                return null;
        ...
        public List<CONTENT_FULL> GetTopLastestContentFulls(int top, int categoryId = 0, string site = "")
        {
