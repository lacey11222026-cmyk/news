        ...
        public override int CreateUpdateDocument ( Document Document )
        {
            try
            {
                ...
                using ( ShopOnlineDataContext datacontext = DataContext )
                    return datacontext.sp_Document_InsertUpdate(_id, _categoryid, _name, _categoryPathway, _description, _createdBy, _publishDate, _createdDate, _effectiveDate, _expiryDate, _status, _hits,_private, _filepath, _code, _signedBy, _signedByDesc);
