...
namespace WebMVC4.Helper
{
    public static class HtmlHelpers
    {
        ...
        public static string BindChildCategories(int categoryId, int type)
        {
            ...
            var _childCategory = new CategoryBO().GetAllChildCategories(categoryId, 18, false) ;
            ...
            if (_childCategory != null && _childCategory.Count > 0)
            {
                ...
                foreach (CATEGORY_FULL _child in _childCategory)
                {
                    ...
                    {
                        html += " <a class='menu1' href=\"" + url + "\">" + _child.Name + "</a>";
                    }
                    else
                    {
                        html += " <a class='menu1' href=\"" + url + "\">" + _child.Name + "</a> <span class='menu1'>|</span>  ";
                    }
