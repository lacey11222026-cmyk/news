...
namespace BIZ
{
    public class ContactBO
    {
        ...
        public List<Contact> GetContacts(string listIds)
        {

            var Contacts = ContactDBBase.Create().GetContacts(listIds);
            if (Contacts == null)
                return null;
        ...
        public List<Contact_FULL> GetContactsByCategory(int categoryId, int status,string name="")
        {
            string keyCache = Constants.CACHE_KEY_ALL_CONTACTS_BYCATEGORY + categoryId + "_" + status + "_" + name;
            ...
            var Contacts = ContactDBBase.Create().GetAllContacts(categoryId, status,name);
            ...
            foreach (var Contact in Contacts)
            {
                ...
                if (lstCachedContacts.Find(x => x.Mobile == ContactFull.Mobile && x.Name == Contact.Name) == null)
