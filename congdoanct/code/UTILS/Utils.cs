...
namespace UTILS
{
    public class Utils
    {
        ...
        public static string SubStringFile(string input, int len)
        {
            if (string.IsNullOrEmpty(input)) return string.Empty;
            if (len > input.Length) return input;
        ...
        public static string GetImageUrlOld(long id, string entity, bool isThumb)
        {
            if (id == 0 || string.IsNullOrEmpty(entity))
                //return "/Images/nophoto.jpg";
                return ConfigurationManager.AppSettings["NoPhotoUrl"];
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append(ConfigurationManager.AppSettings["UploadUrlOld"]).Append(entity).Append("/").Append(Convert.ToInt32(id) / 100000).Append("/").Append(Convert.ToInt32(id) / 100).Append("/").Append(id).Append("/");
