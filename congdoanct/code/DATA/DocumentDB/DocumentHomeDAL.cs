...
namespace DATA.DocumentDB
{
    ...
    {
        public static List<DocumentHome> SelectDynamicPage(string select, string where, string order, int CurrPage, int PageSize, ref int TotalRecord)
        {
            try
            {
        ...
        public static List<DocumentHome> SelectDynamic(string select, string where, string order)
        {
            try
            {
        ...
        public static List<DocumentHome> GetTopLastestDocuments(int top, int categoryId)
        {
            var select = " *";
            if (top > 1)
                select = "TOP(" + top + ") *";
        ...
        public static DocumentHome GetDocument(int DocumentId)
        {
            var select = "*";
        ...
        public static List<DocumentHome> GetDocumentsSearch(string keyword, int categoryId, int status, int pageIndex, int pageSize, string fromdate, string todate, ref int totalRecords)
        {
            var select = "*";
