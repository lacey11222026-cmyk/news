...
namespace WebMVC4.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(int CategoryId, string CateName, int Page = 1, int Type = 0)
        {
            ...
            //    if(articles==null)
            //    {
            //        articles = new ContentBO().GetPageContentFullsFrontend(Page, PageSize, 44, ref Total, "", "", "", "");
            //    }
            //    else
            //    {
            //        if (articles.Count()<=3)
            //        {
            //            var articles2 = new ContentBO().GetPageContentFullsFrontend(Page, PageSize- articles.Count(), 44, ref Total, "", "", "", "");
            //            articles.AddRange(articles2);
            //        }
            //    }
        ...
        public ActionResult Detail(int Id, string Title)
        {
            ...
            var lstRef = GetRefArticle(newsobj.Params, Id);
            if (lstRef != null)
                lstRef = lstRef.Where(x => x.Status == 4).ToList();
            ViewBag.lstRef = lstRef;
