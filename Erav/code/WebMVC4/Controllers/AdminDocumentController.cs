...
namespace WebMVC4.Controllers
{
    ...
    public class AdminDocumentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var lstCate = _staticCategoryList.Where(x => x.ParentId == 3).ToList(); ;
        ...
        public ActionResult ListDocument(int? cateId, int? status, string fromDate, string endDate, string title, int? currentPage, int? pageSize)
        {
            ...
            var data = new DocumentBO().GetDocumentsSearchPaged(title, CateId, 2, 0, 0, 0, Status, CurrPage, RecordPerPage, fromDate, endDate, ref TotalRecord);
            if (data.Count > 0)
        ...
        {
            ViewBag.CategoryList = _staticCategoryList.Where(x => x.ParentId == 3).ToList(); ;
