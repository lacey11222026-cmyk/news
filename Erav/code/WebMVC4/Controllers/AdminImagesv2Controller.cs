...
{
    public class AdminImagesv2Controller : Controller
    {
        //
        // GET: /AdminImagesv2/
        ...
        public ActionResult ListImage(int? currPage, int Month = 0)
        {
            ...
            if (Month == 0)
            {
                Month = int.Parse(DateTime.Now.Year.ToString());

            }
            var folder = ConfigurationManager.AppSettings["UploadPathV2"]  + Month.ToString() + "\\";
            ...
            ViewBag.Month = Month;
            ViewBag.hdfCurrentFolder = ConfigurationManager.AppSettings["UploadUrlV2"] + "/" + Month.ToString()  + "/";
        ...
        public ActionResult SaveUploadedFile()
        {
            ...
            foreach (string fileName in Request.Files)
            {
                ...
                if (file != null && file.ContentLength > 0)
                {
                    ...
                    var folder = ConfigurationManager.AppSettings["UploadPathV2"]  + DateTime.Now.Year.ToString() ;
