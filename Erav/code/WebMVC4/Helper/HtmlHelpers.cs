...
namespace WebMVC4.Helper
{
    public static class HtmlHelpers
    {
        ...
        public static string GetNhaMayUrl(int Id, string Name)
        {
            return $"/thong-tin-nha-may/{Utils.ConvertToRewriteLink(Name)}-{Id}.html";


        }
        public static string GetNhaMayThamGia(int? Region)
        {
            string result = "";
            switch (Region.GetValueOrDefault())
            {
                ...
                default:
                    result = "Tham gia trực tiếp";
                    break;
            }
            return result;

        }
        public static string GetNhaMayLoai(int? Region)
        {
            string result = "";
            switch (Region.GetValueOrDefault())
            {
                ...
                case 1:
                    result = "Nhà máy nhiệt điện than";
                    break;
                case 2:
                    result = "Nhà máy Tua-bin khí";
                    break;
                case 3:
                    result = "Không tham gia";
                    break;
        ...
        public static string GetDocHits(int Region)
        {
            string result = "";
            switch (Region)
            {
        ...
        public static string GetDocAgent(int type)
        {
            ...
            switch (type)
            {
                ...
                case 10:
                    ...
                    break;
                case 3:
                    result = "Bộ Lao động - Thương binh và Xã hội";
                    break;
                case 6:
                    result = "Bộ Tài nguyên và Môi trường";
                    break;
                case 5:
                    result = "Bộ Tài chính";
                    break;
        ...
        public static string GetGPType(int Region)
        {
            string result = "";
            switch (Region)
            {
