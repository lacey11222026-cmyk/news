...
namespace WebMVC4.Controllers
{
    ...
    public class AdminShopController : Controller
    {
        ...
        public ActionResult ListShop(int? status, int? currentPage, int? pageSize, string lang, int? type)
        {
            ...
            data = new ShopBO().GetShopsPaged("",CurrPage, RecordPerPage, ref TotalRecord, Status,lang, Type);
            if (data != null)
