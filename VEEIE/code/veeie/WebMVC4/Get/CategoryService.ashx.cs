            ...
            try
            {
                ...
                switch (method.ToLower())
                {
                    case "get_all_categories":
                        ...
                        var _categoryLang = context.Request["clang"];
                        ...
                        context.Response.Write(context.Request.Params["jsoncallback"] + "(" + Utils.ConvertToJson(new CategoryBO().GetAllCategoriesFull(categoryType,_categoryLang), string.Empty) + ")");
                        return;
