...
namespace DATA
{
    public class ProductDBSproc : ProductDBBase
    {
        ...
        public override Product GetProduct(int productId)
        {
            ...
            {
                ExHandler.Handle(exp, "ProductDBSproc", "GetProduct:productId= " + productId);
                return null;
            }
        }
        ...
        public override IEnumerable<Product> GetProductsDyn(string select, string where, string orderBy)
        {
            ...
            {
                ExHandler.Handle(exp, "ProductDBSproc", "GetProductsDyn where= " + where);
                return null;
            }
        }
        ...
        public override int DeleteProductDyn(string where)
        {
            ...
            {
                ExHandler.Handle(exp, "ProductDBSproc", "DeleteProductDyn Where= " + where);
                return -1;
            }
        }
