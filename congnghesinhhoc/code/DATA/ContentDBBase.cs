...
namespace DATA
{
    public abstract class ContentDBBase : ShopOnlineDBBase
    {
        ...
        public abstract IEnumerable<Content>  GetFilterContents(int pageIndex, int pageSize, string title, int categoryId, List<int> lstcate, int status, string createdby, ref int totalRecords, string fromdate = "", string todate = "", string lststatus = "", string alias = "",string orderBy= "PublishDate DESC",string lang="");
        ...
        public abstract IEnumerable<Content> GetTopLastestContents(int top, int categoryId, string site,string lang);
        public abstract IEnumerable<Content> GetTopViewContents(int top, int categoryId,string lang, string title, string fromdate, string todate);
