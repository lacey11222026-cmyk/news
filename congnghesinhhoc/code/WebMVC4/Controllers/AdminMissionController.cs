...
namespace WebMVC4.Controllers
{
    ...
    public class AdminMissionController : Controller
    {
        ...
        public ActionResult GetMissionDetail(int Id = 0)
        {
            ...
            var model = new MISSION_FULL { Id = 0, PublishDate = DateTime.Now, FromDate = 0, ToDate = 0, Accept = 0, Result = 2 };
            if (Id > 0)
            {
                ...
                ViewBag.Title = "Cập nhật nhiệm vụ";
            }
            else
            {
                ViewBag.Title = "Thêm mới nhiệm vụ";
            }
            return View(model);
        }
