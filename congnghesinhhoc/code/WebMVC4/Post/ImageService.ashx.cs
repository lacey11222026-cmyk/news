...
namespace WebMVC4.Post
{
    ...
    public class ImageService : IHttpHandler, IReadOnlySessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!HttpContext.Current.User.IsInRole("Administrator") && !HttpContext.Current.User.IsInRole("Sales") && !HttpContext.Current.User.IsInRole("Album") && !HttpContext.Current.User.IsInRole("NewsEdit") && !HttpContext.Current.User.IsInRole("NewsPublish"))
            {
