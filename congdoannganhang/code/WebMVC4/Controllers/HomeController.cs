...
namespace WebMVC4.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ViewBag.interestRate2 = new SystemConfigBO().GetValueByKey("InterestRate2");
           ViewBag.interestRate1 = new SystemConfigBO().GetValueByKey("InterestRate1");
            var data = new SystemConfigBO().GetRate();
        ...
        [OutputCache(Duration = 60, VaryByParam = "*", VaryByCustom = "browser")]
        public ActionResult Elearning(int CategoryId, int MaxLastestNews = 0)
        {
