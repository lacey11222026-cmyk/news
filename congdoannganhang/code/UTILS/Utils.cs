...
namespace UTILS
{
    public class Utils
    {
        ...
        {
            //hard code cho 1 so webapp
            try
            {
                if (string.IsNullOrEmpty(linkOrigin))
                    return "";
        ...
        public static string FormatUrlRewriteByType(int id, string title, int categoryType, string link = "")
        {
            try
            {
                ...
                else if (categoryType == (byte)UTILS.Constants.CategoryType.Channel)
                {
                    entity = "Channel";
                ...
                switch (entity)
                {
                    ...
                    case "Channel":
                        if (isEnableURLRewrite > 0)
                        {
                            ...
                            _url += "kenh-tin/p" + id + "/" + _title + ".html";
                        }
                        else
                        {
                    ...
                    case "Articles":
                        if (isEnableURLRewrite > 0)
                        {
                            ...
                            {
                                if (id == 110)
                                    return "/trang-chu-video.html";
                                if (id == 112)
                                    return "/trang-chu-audio.html";
                                _url += "tin-tuc/c" + id + "/" + _title ;
        ...
        public static string GetImageUrl2(long id, string entity, bool isThumb)
        {
            if (id == 0 || string.IsNullOrEmpty(entity))
                //return "/Images/nophoto.jpg";
                return ConfigurationManager.AppSettings["NoPhotoUrl"];
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.Append(ConfigurationManager.AppSettings["UploadUrl2"]).Append(entity).Append("/").Append(Convert.ToInt32(id) / 100000).Append("/").Append(Convert.ToInt32(id) / 100).Append("/").Append(id).Append("/");
