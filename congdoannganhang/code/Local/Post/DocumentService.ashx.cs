    ...
    public class DocumentService : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                int return_val;
                if (!HttpContext.Current.User.IsInRole("Administrator") && !HttpContext.Current.User.IsInRole("Document") && !HttpContext.Current.User.IsInRole("Local"))
                {
                ...
                switch (method.ToLower())
                {
                    case "save":
                        ...
                        var _private = context.Request.Form["_private"];
                        ...
                        Document.Private = Convert.ToInt32(_private);
