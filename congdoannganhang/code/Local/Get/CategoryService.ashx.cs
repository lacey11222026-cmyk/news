            ...
            try
            {
                ...
                switch (method.ToLower())
                {
                    case "get_all_categories":
                        ...
                        context.Response.Write(context.Request.Params["jsoncallback"] + "(" + Utils.ConvertToJson(new CategoryBO().GetAllCategoriesFull(categoryType), "") + ")");
                        return;
                    case "get_categorybyparent":
                        ...
                        context.Response.Write(context.Request.Params["jsoncallback"] + "(" + Utils.ConvertToJson(new CategoryBO().GetAllChildCategories(Convert.ToInt32(categoryId),10,false), "") + ")");
                        return;
                    case "get_category":
                        categoryId = context.Request["_id"];
                        if (!Utils.IsNumber(categoryId))
                        ...
                        context.Response.Write(context.Request.Params["jsoncallback"] + "(" + Utils.ConvertToJson(new CategoryBO().GetCategoryFull(Convert.ToInt32(categoryId)), "") + ")");
                        return;
