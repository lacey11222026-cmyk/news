...
namespace Local.Controllers
{
    public class HomeController : Controller
    {
        ...
        //[OutputCache(Duration = 120, VaryByParam = "none", VaryByCustom = "browser")]
        [ChildActionOnly]
        public ActionResult TopDocument(int CategoryId, int MaxDocuments)
        {
            ...
            var model = new TopDocumentModel
            {
                Url =
                    UTILS.Utils.FormatUrlRewriteByType(CategoryId, cateobj.Name, (int)UTILS.Constants.CategoryType.Doc),
        ...
        [ChildActionOnly]
        public ActionResult TopDocument2(int CategoryId, int MaxDocuments)
        {
        ...
        [ChildActionOnly]
        public ActionResult TopDocument3(int CategoryId, int MaxDocuments)
        {
